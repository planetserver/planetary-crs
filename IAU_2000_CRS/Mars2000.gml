    ...
    <gml:GeodeticDatum gml:id="ogrcrs517">
      ...
      <gml:usesEllipsoid>
        <gml:Ellipsoid gml:id="ogrcrs519">
          <gml:metaDataProperty></gml:metaDataProperty>
          <gml:identifier codeSpace="OGP">http://www.opengis.net/def/meridian/EPSG/0/8901</gml:identifier>
          <gml:name>Mars_2000_IAU_IAG</gml:name>
          <gml:semiMajorAxis uom="http://www.opengis.net/def/uom/EPSG/0/9001">3396190.0</gml:semiMajorAxis>
          <gml:secondDefiningParameter>
            <gml:SecondDefiningParameter>
             <gml:inverseFlattening uom="http://www.opengis.net/def/uom/EPSG/0/9201">169.89444722361179</gml:inverseFlattening>
            </gml:SecondDefiningParameter>
          </gml:secondDefiningParameter>
        </gml:Ellipsoid>
      </gml:usesEllipsoid>
