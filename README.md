...
Note that the second of the gml file needs to be added manually.
The UsesAxis identifier from the GML files in SpatialReference needs to be change by axis
